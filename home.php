            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>To each their home.℠</h5>
                        <p>Let’s find a home that’s perfect for you</p>
                        <form>
                            <input type="text" placeholder="Type a place" class="p-1 ms-5 me-2 w-50 ">
                            <button id="Show-login" type="submit" class="btn button_style">Search</button>
                        </form>
                    </div>
                </div>
...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="row">
            <?php
            $query = mysqli_query($con, "SELECT * FROM propery_details");
