...
if (isset($_POST['AddPSubmit'])) {
    ...
    $sql = "INSERT INTO propery_details (p_name,bhk,selling_type,p_owner,p_discription,floor,total_floor,price,area_size,city,address,state,p_type,property_age,swimming_pool,parking,gym,Alivator,cctv,water_supply,security,img1,img2,img3,status)
    values ('$p_name','$BHK','$Selling_type','$p_owner','$p_discription','$floor','$t_floor','$price','$area_size','$city','$address','$state','$p_type','$property_age','$swimming_pool','$gym','$parking','$Alivator','$cctv','$water_supply','$security','$aimage1','$aimage2','$aimage3','Approved')";
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid mt-5">
                ...
                <div class="container bg-white p-5 shadow mb-5">
                    ...
                    <div class="row row-col-1 row-col-md-2 row-col-lg-2">
                        ...
                        <input type="submit" name="AddPSubmit" class="form-control bg-success text-white w-50" value="Submit" />
                        </form>
                    </div>
                    <?php
